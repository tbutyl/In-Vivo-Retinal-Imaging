    ...
    for img_path in imgs:
        ...
        try:
            ...
            try:
                ...
                ax[0].set_title(root)
                ax[1].plot(np.arange(50,550,50), ring_densities, marker='o')
                ax[0].imshow(img, cmap='gray')
                ax[0].grid(b=False)
                #ax[0].set_xlabel('Intensity Mean: {}'.format(np.mean(image)))
                #ax[0].set_title(transformed_center.T[0:2])
